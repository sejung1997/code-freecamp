...
// 3. html의 결과 박스(class="result")의 내용을 결과값으로 바꿔준다

function add () {
    // 여기에 코드를 입력하세요
   const aNum = Number(document.getElementById("a").value) 
   const bNum = Number(document.getElementById("b").value)
   const plus = aNum + bNum
